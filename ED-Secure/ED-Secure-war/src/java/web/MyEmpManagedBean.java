...
//        return (salary > 0.0);
    ...
    private String setUserDetails() {
        ...
        EmployeeDTO e = employeeManagement.getUserDetails(empId, password);//0009
    ...
    private String setStudentDetails() {

        if (isNull(empId) || conversation == null) {
            return "debug";
        }

        EmployeeDTO e = employeeManagement.getStudentDetails(empId);
